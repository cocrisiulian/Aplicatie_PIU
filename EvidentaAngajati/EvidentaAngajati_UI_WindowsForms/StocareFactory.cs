        ...
        public static IStocareData GetAdministratorStocare()
        {
            ...
            if (formatSalvare != null)
            {
                switch (formatSalvare)
                {
                    default:
                    case "bin":
                        return new AdministrareAngajatii_FisierBinar(caleCompletaFisier + "." + formatSalvare);
                    case "txt":
                        return new AdministrareAngajati_FisierText(caleCompletaFisier + "." + formatSalvare);
                }
            }
